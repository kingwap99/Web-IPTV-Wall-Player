...
- Hero 切換時音訊淡出／淡入
- 瀏覽器擋下自動播放時，主頻道先以靜音播放（畫面不卡），點一下畫面即開啟聲音
- Hero 單按進入全螢幕，再按恢復原本版面與頁數
- Hero 右鍵選單：加入最愛、頻道資訊、調整位置、暫停、音量、翻頁、分類、版面、頻道庫、移除
- 頻道右鍵／長按選單：加入最愛、頻道資訊、調整位置、移除（中央大頻道與小頻道皆可）
- 頻道排序：直接把頻道拖曳到另一台上交換位置，或點擊兩台交換；可完成或取消還原
